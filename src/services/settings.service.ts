...
const defaultIntegrations: IntegrationCard[] = [
  {
    ...
    name: "MikroTik",
    category: "network",
    description: "RouterOS management & API bridge",
    status: "connected",
    configured: true,
  },
  {
    ...
    name: "FreeRADIUS",
    category: "network",
    description: "AAA server for guest authentication",
    status: "connected",
    configured: true,
  },
  {
    ...
    name: "WireGuard",
    category: "network",
    description: "Modern VPN tunneling for edge routers",
    status: "connected",
    configured: true,
  },
  {
    ...
    name: "Opera PMS",
    category: "pms",
    description: "Oracle Opera property management system",
    status: "disconnected",
    configured: false,
  },
  {
    ...
    name: "Hotelogix",
    category: "pms",
    description: "Cloud hotel PMS integration",
    status: "disconnected",
    configured: false,
  },
  {
    ...
    name: "Cloudbeds",
    category: "pms",
    description: "Cloudbeds reservations sync",
    status: "connected",
    configured: true,
  },
  {
    ...
    name: "Stayflexi",
    category: "pms",
    description: "Unified hotel operations",
    status: "disconnected",
    configured: false,
  },
  {
  ...
  },
  {
    ...
    name: "Stripe",
    category: "payment",
    description: "Global card processing",
    status: "connected",
    configured: true,
  },
  {
  ...
  },
  {
    ...
    name: "OpenAI",
    category: "ai",
    description: "GPT-powered assistant and copilots",
    status: "connected",
    configured: true,
  },
];
...
let state: PlatformSettings = {
  ...
  email: {
    ...
    password: rand(24),
    fromAddress: "noreply@cloudguest.io",
    connectionStatus: "connected",
    lastTestedAt: daysFromNow(-1),
  },
  sms: {
    provider: "twilio",
    apiKey: rand(32),
    senderId: "CGUEST",
    templateId: "TMP_00123",
    connectionStatus: "connected",
    lastTestedAt: daysFromNow(-2),
  },
  storage: {
    provider: "aws_s3",
    bucket: "cloudguest-prod",
    region: "us-east-1",
    accessKey: rand(20),
    secretKey: rand(40),
    usageGb: 148.3,
  ...
  payment: {
    provider: "stripe",
    publishableKey: "pk_live_" + rand(24),
    secretKey: "sk_live_" + rand(24),
    webhookSecret: "whsec_" + rand(28),
    currency: "USD",
    taxPercent: 8.5,
    autoInvoice: true,
  },
  api: {
    keys: seedKeys,
    webhookUrl: "https://api.cloudguest.io/v1/webhook",
  ...
  backup: {
    schedule: "daily",
    lastBackupAt: daysFromNow(-1),
    nextBackupAt: daysFromNow(0),
    history: seedBackups,
  },
  featureFlags: {
    whiteLabel: true,
  ...
  license: {
    ...
    organizationLimit: 500,
    routerLimit: 10_000,
    guestLimit: 1_000_000,
    expiryDate: daysFromNow(365),
  },
  about: {
    platformVersion: "2.14.0",
    buildNumber: "build.20260719.1",
...
export const settingsService = {
  ...
  async backupNow(): Promise<BackupEntry> {
    ...
    const entry: BackupEntry = {
      ...
      createdAt: now(),
      sizeMb: 260 + Math.round(Math.random() * 80),
      type: "manual",
      status: "success",
    };
