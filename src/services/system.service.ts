...
const FEATURES: MarketplaceFeature[] = [
  {
    ...
    name: "Guest WiFi",
    category: "Networking",
    description: "Onboard guests with captive portals and OTP login.",
    icon: "Wifi",
    status: "installed",
    plan: "starter",
    users: 128_540,
  ...
  {
    id: "captive-portal",
    name: "Captive Portal Builder",
    category: "Networking",
    description: "Drag-and-drop portal design with live preview.",
    icon: "LayoutTemplate",
    status: "installed",
    plan: "professional",
    users: 63_210,
  ...
  },
  {
    ...
    name: "FreeRADIUS",
    category: "Auth",
    description: "Enterprise AAA for MikroTik & vendor gear.",
    icon: "ShieldCheck",
    status: "installed",
    plan: "professional",
    users: 21_450,
  ...
  },
  {
    ...
    category: "Networking",
    description: "Zero-config VPN for remote routers.",
    icon: "Network",
    status: "installed",
    plan: "professional",
    users: 18_770,
  ...
  },
  {
    ...
    category: "Analytics",
    description: "Cohorts, funnels, and revenue attribution.",
    icon: "BarChart3",
    status: "upgrade",
    plan: "enterprise",
    users: 9_320,
  ...
  },
  {
    ...
    category: "Analytics",
    description: "CPU/RAM/latency streams for every router.",
    icon: "Activity",
    status: "installed",
    plan: "professional",
    users: 42_800,
  ...
  },
  {
    ...
    name: "AI Assistant",
    category: "Automation",
    description: "Copilot for support & network diagnostics.",
    icon: "Sparkles",
    status: "available",
    plan: "enterprise",
    users: 3_120,
  ...
  },
  {
    ...
    name: "Voucher Login",
    category: "Auth",
    description: "Generate & sell prepaid guest vouchers.",
    icon: "Ticket",
    status: "installed",
    plan: "starter",
    users: 87_100,
  ...
  },
  {
    ...
    name: "QR Login",
    category: "Auth",
    description: "One-scan guest onboarding.",
    icon: "QrCode",
    status: "installed",
    plan: "starter",
    users: 96_300,
  ...
  },
  {
    ...
    name: "Social Login",
    category: "Auth",
    description: "Google, Apple, Facebook & Microsoft.",
    icon: "Users",
    status: "available",
    plan: "professional",
    users: 14_090,
  ...
  },
  {
    ...
    name: "White Label",
    category: "Branding",
    description: "Full custom branding & domains.",
    icon: "Palette",
    status: "upgrade",
    plan: "enterprise",
    users: 5_800,
  ...
  },
  {
    ...
    description: "Opera, Cloudbeds, Mews & Hotelogix.",
    icon: "Building2",
    status: "available",
    plan: "enterprise",
    users: 2_450,
  ...
  },
  {
    ...
    name: "API Access",
    category: "Developer",
    description: "REST + Webhooks for automation.",
    icon: "Code2",
    status: "installed",
    plan: "professional",
    users: 11_240,
  ...
  },
  {
    ...
    name: "Notifications",
    category: "Automation",
    description: "Multi-channel alerts and digest emails.",
    icon: "Bell",
    status: "installed",
    plan: "starter",
    users: 132_400,
  ...
  },
  {
    ...
    name: "Reports",
    category: "Analytics",
    description: "Scheduled PDF / Excel exports.",
    icon: "FileBarChart",
    status: "installed",
    plan: "professional",
    users: 27_600,
  ...
  },
  {
    ...
    name: "Billing",
    category: "Commerce",
    description: "Stripe & Razorpay revenue engine.",
    icon: "Receipt",
    status: "installed",
    plan: "professional",
    users: 8_400,
...
let WEBHOOKS: WebhookRow[] = [
  {
    id: "w1",
    url: "https://hooks.acme.io/cloudguest",
    events: ["guest.connected", "router.offline"],
    status: "active",
    createdAt: iso(-60),
  },
  {
    id: "w2",
    url: "https://ops.acme.io/alerts",
...
const INTEGRATIONS: IntegrationDef[] = [
  {
    ...
    name: "MikroTik",
    category: "network",
    description: "RouterOS API bridge",
    icon: "Router",
    status: "connected",
  },
  {
    ...
    name: "FreeRADIUS",
    category: "auth",
    description: "AAA for guest login",
    icon: "ShieldCheck",
    status: "connected",
  },
  {
  ...
  },
  {
    ...
    name: "Razorpay",
    category: "payments",
    description: "India payments & UPI",
    icon: "CreditCard",
    status: "connected",
  },
  {
...
const NOTES = [
  {
    ...
    description: "MK-047 lost connection 3 min ago.",
    category: "router" as NotifCategory,
    priority: "high" as NotifPriority,
  },
  {
    title: "High CPU",
    description: "Router MK-012 CPU sustained at 92%.",
    category: "router" as NotifCategory,
    priority: "medium" as NotifPriority,
  },
  {
    title: "Bandwidth limit reached",
    description: "Guest quota exceeded on Suite 214.",
    category: "guest" as NotifCategory,
    priority: "medium" as NotifPriority,
  },
  {
    title: "Subscription renewing",
    description: "Renews in 21 days for $499.",
    category: "subscription" as NotifCategory,
    priority: "low" as NotifPriority,
  },
  {
    title: "Failed login attempts",
    description: "5 failed attempts for admin@acme.io.",
    category: "security" as NotifCategory,
    priority: "high" as NotifPriority,
  },
  {
    title: "WireGuard tunnel down",
    description: "Tunnel wg-eu-04 failed handshake.",
    category: "wireguard" as NotifCategory,
    priority: "critical" as NotifPriority,
  },
  {
    title: "Voucher batch expired",
    description: "Batch VB-2098 expired today.",
    category: "wifi" as NotifCategory,
    priority: "low" as NotifPriority,
  },
  {
    title: "Maintenance window",
    description: "Scheduled Sun 02:00 UTC.",
    category: "maintenance" as NotifCategory,
    priority: "low" as NotifPriority,
  },
  {
    title: "Portal published",
    description: "Lobby portal v12 is live.",
    category: "portal" as NotifCategory,
    priority: "low" as NotifPriority,
  },
  {
    title: "Payment received",
    description: "$499 from Acme Hotels.",
    category: "billing" as NotifCategory,
    priority: "low" as NotifPriority,
  },
];
...
const HELP: HelpArticle[] = [
  {
    id: "h1",
    title: "Getting started with CloudGuest",
    category: "docs",
    summary: "Set up your first property in 10 minutes.",
    updatedAt: iso(-3),
  },
  {
    id: "h2",
    ...
    category: "video",
    summary: "Watch the router registration wizard end-to-end.",
    updatedAt: iso(-6),
  },
  {
    id: "h3",
    title: "Voucher billing FAQ",
    category: "faq",
    summary: "Common questions from front-desk teams.",
    updatedAt: iso(-9),
  },
  {
    id: "h4",
    ...
    category: "api",
    summary: "Endpoints, auth, and rate limits.",
    updatedAt: iso(-1),
  },
  {
    id: "h5",
    ...
    category: "release",
    summary: "Ships new marketplace + system monitoring.",
    updatedAt: iso(-2),
  },
  {
    id: "h6",
    title: "Portal branding playbook",
    category: "kb",
    summary: "Best practices for enterprise brands.",
    updatedAt: iso(-11),
  },
];
