...
export const CUSTOMERS: Customer[] = [
  ...
  },
  {
    ...
    since: "Jul 2024",
    region: "West",
    modules: ["Dashboard", "Users", "Analytics", "Vouchers", "Portal"],
  },
  {
    id: "c-3",
    name: "Phoenix Marketcity",
    type: "Mall",
    email: "facilities@phoenix.com",
    phone: "+91 91670 88991",
    plan: "Enterprise",
    locations: 6,
    online: 1240,
    mrr: 3100,
    ...
    since: "Jan 2024",
    region: "West",
    modules: ["Dashboard", "Users", "Analytics", "Hotspot", "VLANs", "ISP Routing", "Alerts"],
  },
  {
    id: "c-4",
    name: "Apollo Hospitals",
    type: "Hospital",
    email: "network@apollo.com",
    phone: "+91 93810 22114",
    plan: "Enterprise",
    locations: 9,
    online: 640,
    mrr: 2900,
    ...
    since: "Nov 2023",
    region: "South",
    modules: ["Dashboard", "Users", "Policies", "VLANs", "Whitelist", "Alerts"],
  },
  {
    id: "c-5",
    name: "WeWork India",
    type: "Co-working",
    email: "ops@wework.co.in",
    phone: "+91 99720 55447",
    plan: "Growth",
    locations: 22,
    online: 930,
    mrr: 1900,
    ...
    since: "Jun 2026",
    region: "North",
    modules: ["Dashboard", "Users", "Analytics", "Vouchers"],
  },
  {
    id: "c-6",
    name: "Reliance Trends",
    type: "Retail",
    email: "wifi@trends.com",
    phone: "+91 90040 33220",
    plan: "Starter",
    locations: 48,
    online: 210,
    mrr: 900,
    ...
    since: "Feb 2025",
    region: "North",
    modules: ["Dashboard", "Users", "Portal"],
  },
  {
    id: "c-7",
    name: "Chai Point",
    type: "Cafe",
    email: "tech@chaipoint.com",
    phone: "+91 97310 66558",
    plan: "Growth",
    locations: 51,
    online: 388,
    mrr: 1500,
    ...
    since: "Sep 2024",
    region: "South",
    modules: ["Dashboard", "Users", "Analytics", "Vouchers", "Campaigns"],
  },
  {
    id: "c-8",
    name: "Lemon Tree Hotels",
    type: "Hotel",
    email: "corp.it@lemontree.com",
    ...
    since: "Apr 2024",
    region: "North",
    modules: ["Dashboard", "Users", "Analytics", "Hotspot", "RaaS", "Portal", "Alerts"],
  },
];
...
export const TICKETS: Ticket[] = [
  {
    id: "TK-8801",
    subject: "OTP not delivering on Airtel",
    customer: "The Hosteller",
    priority: "Urgent",
    status: "Open",
    assignee: "Neha",
  ...
  {
    id: "TK-8802",
    subject: "Portal logo not updating",
    customer: "Chai Point",
    priority: "Normal",
    status: "Pending",
    assignee: "Rohan",
  ...
  {
    id: "TK-8803",
    subject: "Router HOSP002-A keeps rebooting",
    customer: "Apollo Hospitals",
    priority: "High",
    status: "Open",
    assignee: "Neha",
  ...
  {
    id: "TK-8804",
    subject: "Add VLAN for staff network",
    customer: "WeWork India",
    priority: "Normal",
    status: "Resolved",
    assignee: "Amir",
  ...
  {
    id: "TK-8805",
    subject: "Billing overdue reminder dispute",
    customer: "Reliance Trends",
    priority: "High",
    status: "Pending",
    assignee: "Rohan",
...
export const SESSIONS_24H = [
  1200, 980, 760, 640, 590, 620, 910, 1480, 2100, 2680, 3020, 3180, 3240, 3160, 3010, 2980, 3120,
  3360, 3520, 3410, 2980, 2440, 1880, 1460,
