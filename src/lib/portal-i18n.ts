...
const EN: Dict = {
  ...
  codeResentConfirm: "New code sent",
  ...
  // the most guest-visible untranslated strings left on the journey).
  notSetUpTitle: "This venue's guest WiFi isn't set up yet",
  notSetUpBody:
    "No active sign-in configuration was found for this location. Please ask venue staff for assistance.",
  troubleConnectingTitle: "Having trouble connecting",
  ...
  stillConnectingLabel: "Still connecting...",
  slowRetryCta: "Taking a while -- retry",
  ...
  marketingConsentTitle: "Offers from this venue",
...
const HI: Dict = {
  ...
  codeResentConfirm: "नया कोड भेज दिया गया",
  ...
  marketingConsentTitle: "इस जगह से ऑफ़र",
...
const BN: Dict = {
  ...
  codeResentConfirm: "নতুন কোড পাঠানো হয়েছে",
  ...
  marketingConsentTitle: "এই জায়গা থেকে অফার",
...
const MR: Dict = {
  ...
  codeResentConfirm: "नवीन code पाठवला",
  ...
  marketingConsentTitle: "या ठिकाणाकडून ऑफर",
...
const TE: Dict = {
  ...
  codeResentConfirm: "కొత్త కోడ్ పంపాము",
  ...
  changeEmailLabel: "ఇమెయిల్ మార్చండి",
  ...
  marketingConsentTitle: "ఈ వేదిక నుండి ఆఫర్లు",
...
const TA: Dict = {
  ...
  codeResentConfirm: "புதிய குறியீடு அனுப்பப்பட்டது",
  ...
  changeEmailLabel: "மின்னஞ்சலை மாற்று",
  ...
  marketingConsentTitle: "இந்த இடத்திலிருந்து சலுகைகள்",
...
const GU: Dict = {
  ...
  codeResentConfirm: "નવો કોડ મોકલાયો",
  ...
  marketingConsentTitle: "આ સ્થળ તરફથી ઓફર",
...
const KN: Dict = {
  ...
  codeResentConfirm: "ಹೊಸ ಕೋಡ್ ಕಳುಹಿಸಲಾಗಿದೆ",
  ...
  marketingConsentTitle: "ಈ ಸ್ಥಳದಿಂದ ಆಫರ್‌ಗಳು",
...
const ML: Dict = {
  ...
  codeResentConfirm: "പുതിയ കോഡ് അയച്ചു",
  ...
  marketingConsentTitle: "ഈ സ്ഥാപനത്തിൽ നിന്നുള്ള ഓഫറുകൾ",
...
const PA: Dict = {
  ...
  codeResentConfirm: "ਨਵਾਂ code ਭੇਜ ਦਿੱਤਾ",
  ...
  marketingConsentTitle: "ਇਸ ਥਾਂ ਤੋਂ ਆਫ਼ਰ",
