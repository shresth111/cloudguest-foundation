...
const FLAGS: FeatureFlag[] = [
  {
    id: "branding",
    name: "Branding",
    description: "Custom white-label branding for portals",
    icon: Palette,
    enabled: true,
    category: "portal",
  },
  ...
  },
  {
    id: "email-otp",
    name: "Email OTP",
    description: "One-time password via email authentication",
    icon: Mail,
    enabled: true,
    category: "auth",
  },
  {
    id: "sms-otp",
    name: "SMS OTP",
    description: "One-time password via SMS authentication",
    icon: MessageSquare,
    enabled: true,
    category: "auth",
  },
  {
    id: "whatsapp-otp",
    name: "WhatsApp OTP",
    description: "One-time password via WhatsApp",
    icon: Smartphone,
    enabled: false,
    category: "auth",
  },
  ...
  },
  {
    id: "radius-proxy",
    name: "RADIUS Proxy",
    description: "RADIUS authentication proxy service",
    icon: Radio,
    enabled: true,
    category: "network",
  },
  {
    ...
    description: "Virtual LAN configuration and mapping",
    icon: Network,
    enabled: true,
    category: "network",
  },
  ...
  },
  {
    id: "cloud-backup",
    name: "Cloud Backup",
    description: "Automated cloud configuration backup",
    icon: Cloud,
    enabled: true,
    category: "system",
  },
  ...
  },
  {
    id: "social-login",
    name: "Social Login",
    description: "Login via Google, Facebook, LinkedIn",
    icon: Globe,
    enabled: true,
    category: "auth",
  },
...
function FeatureFlagsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Feature flags"
        description={`Manage enterprise feature toggles — ${enabledCount}/${totalCount} enabled`}
      />
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {filtered.map((flag) => {
          ...
          return (
            <Card
              key={flag.id}
              className={`transition-all ${flag.enabled ? "border-primary/30" : "opacity-70"}`}
            >
