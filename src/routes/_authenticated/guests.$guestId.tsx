...
import { GuestStatusBadge, GuestTypeBadge, LoginMethodBadge } from "@/components/guests/GuestBadges";
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Link to="/guests" className="inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <LoginMethodBadge method={guest.loginMethod} />
        </div>
        <p className="text-sm text-muted-foreground">
          {guest.id} · {guest.email} · {guest.mobile} · {guest.locationName}
        </p>
      </div>
