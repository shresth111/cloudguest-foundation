...
const INITIAL: Feature[] = [
  {
    ...
    category: "Access",
    icon: Wifi,
    description: "Core guest access module.",
    enabled: true,
  },
  {
    key: "captive-portal",
    ...
    category: "Access",
    icon: LayoutTemplate,
    description: "Splash & landing runtime.",
    enabled: true,
  },
  {
    key: "voucher",
    ...
    category: "Access",
    icon: Ticket,
    description: "Voucher plans and bulk generation.",
    enabled: true,
  },
  {
    key: "qr-login",
    ...
    category: "Auth",
    icon: QrCode,
    description: "Scan-to-connect authentication.",
    enabled: true,
  },
  {
    key: "otp-login",
    ...
    category: "Auth",
    icon: KeyRound,
    description: "SMS / Email one-time passwords.",
    enabled: true,
  },
  {
    key: "social-login",
    ...
    category: "Auth",
    icon: MessageCircle,
    description: "Google, Facebook, Apple, LinkedIn.",
    enabled: false,
  },
  {
    key: "freeradius",
    ...
    category: "Network",
    icon: Radio,
    description: "RADIUS AAA integration.",
    enabled: true,
  },
  {
    key: "wireguard",
    ...
    category: "Network",
    icon: ShieldCheck,
    description: "Site-to-cloud tunnels.",
    enabled: true,
  },
  {
    key: "monitoring",
    ...
    category: "Ops",
    icon: Activity,
    description: "Real-time router telemetry.",
    enabled: true,
  },
  {
    key: "reports",
    ...
    category: "Ops",
    icon: BarChart3,
    description: "Scheduled export delivery.",
    enabled: true,
  },
  {
    key: "analytics",
    ...
    category: "Ops",
    icon: BarChart3,
    description: "Guest & network insights.",
    enabled: true,
  },
  {
    key: "notifications",
    ...
    category: "Ops",
    icon: Bell,
    description: "Email, SMS, webhook fan-out.",
    enabled: true,
  },
  {
    key: "api",
  ...
  },
  {
    ...
    category: "Growth",
    icon: Palette,
    description: "Custom branding & domains.",
    enabled: true,
  },
  {
    key: "ai-assistant",
    ...
    category: "Growth",
    icon: Sparkles,
    description: "In-product AI copilot.",
    enabled: false,
  },
];
