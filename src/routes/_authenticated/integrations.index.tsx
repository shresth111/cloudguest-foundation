...
function IntegrationsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Integrations"
        description="Connect CloudGuest with the tools your team already uses."
      />
                ...
                {i.status === "connected" ? (
                  <>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => toast.success(`${i.name} settings opened`)}
                    >
                      Configure
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => toast.success(`${i.name} disconnected`)}
                    >
                      Disconnect
                    </Button>
                  </>
                ) : (
                  <Button size="sm" onClick={() => toast.success(`${i.name} connected`)}>
                    Connect
                  </Button>
                )}
              </CardFooter>
