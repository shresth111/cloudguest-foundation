...
const EVENTS: AuditEvent[] = [
  {
    ...
    ip: "203.0.113.42",
    device: "Chrome / macOS",
    details: "Successful login from Mumbai office",
  },
  {
    id: "ae2",
    ...
    details: "Created new location: Bangalore DC",
  },
  {
    id: "ae3",
    time: new Date(Date.now() - 300000),
    user: "system",
    action: "Router offline",
    module: "router",
    status: "failure",
    ip: "—",
    device: "System",
    details: "GW-07 at Bangalore DC went offline",
  },
  {
    id: "ae4",
    ...
    ip: "192.0.2.88",
    device: "Safari / iOS",
    details: "VLAN 100 extended to Chennai Office",
  },
  {
    id: "ae5",
    time: new Date(Date.now() - 900000),
    user: "mike@acme.com",
    action: "Generate voucher batch",
    module: "system",
    status: "success",
    ip: "203.0.113.55",
    device: "Edge / Windows",
    details: "500 vouchers generated for Mumbai HQ",
  },
  {
    id: "ae6",
    time: new Date(Date.now() - 1800000),
    user: "admin@acme.com",
    action: "Update bandwidth policy",
    module: "network",
    status: "success",
    ip: "203.0.113.42",
    device: "Chrome / macOS",
    details: "Bandwidth policy updated for Delhi Office",
  },
  {
    id: "ae7",
  ...
  },
  {
    ...
    details: "Invalid password — 3rd attempt from unknown IP",
  },
  {
    id: "ae9",
    ...
    ip: "203.0.113.42",
    device: "Chrome / macOS",
    details: "API key 'Production-Key' rotated",
  },
  {
    id: "ae10",
    ...
    details: "Invoice INV-2025-0421 for $1,299.00",
  },
  {
    id: "ae11",
    ...
    ip: "203.0.113.42",
    device: "Chrome / macOS",
    details: "User 'mike@acme.com' promoted to Location Manager",
  },
  {
    id: "ae12",
    time: new Date(Date.now() - 21600000),
    user: "system",
    action: "SSL cert renewed",
    module: "system",
    status: "success",
    ip: "—",
    device: "System",
    details: "SSL certificate renewed for portal.acme.com",
  },
];
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Complete audit trail of all platform actions and events."
      />
