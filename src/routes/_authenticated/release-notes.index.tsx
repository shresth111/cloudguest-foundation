...
const RELEASES: Release[] = [
  {
    ...
    features: [
      ...
      "Advanced VLAN mapping UI",
      "Executive analytics dashboard",
    ],
    improvements: [
      "50% faster portal load times",
      "Improved session explorer filtering",
      "Enhanced RADIUS proxy logging",
    ],
    bugfixes: [
      "Fixed session timeout not reflecting in UI",
      "Resolved SSID broadcast toggle issue",
      "Fixed location map rendering on Safari",
    ],
    knownIssues: [
      "WhatsApp OTP may have 2-3s delay in Southeast Asia region",
      "VLAN mapping export fails for >100 VLANs",
    ],
    upcoming: [
  ...
  },
  {
    ...
    type: "minor",
    features: [
      "Live session explorer with real-time updates",
      "Device topology visualization",
      "Feature flags management UI",
    ],
    improvements: [
      "Re-designed notification center",
      "Improved audit trail search",
      "Better mobile responsiveness",
    ],
    bugfixes: [
      "Fixed null pointer in router status check",
      "Resolved billing invoice date calculations",
      "Fixed portal preview on mobile viewports",
    ],
    knownIssues: [
      "Notification bell badge count may lag by 30s",
      "Topology auto-layout breaks for >50 nodes",
    ],
  ...
  },
  {
    ...
    improvements: [
      "Migrated to TanStack Router for file-based routing",
    ...
    bugfixes: [
      ...
      "Resolved WebSocket connection drops on unstable networks",
      "Fixed CSV export encoding for non-Latin characters",
    ],
    knownIssues: [
      "Legacy browser support limited to last 2 versions",
      "Some third-party integrations require re-authorization",
    ],
  ...
  },
  {
    ...
    type: "minor",
    features: [
      "Guest portal builder with templates",
      "Campaign management",
...
function ReleaseNotesPage() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Release notes"
        description="Track every change, improvement, and fix across platform versions."
      />
            ...
            <div className="flex gap-5">
              ...
              <div className="min-w-0 flex-1">
                <div className="mb-3 flex flex-wrap items-center gap-2">
                  ...
                  <Badge variant="outline" className={cn("capitalize", TYPE_STYLES[release.type])}>
                    {release.type}
                  </Badge>
                ...
                <Card>
                  <CardContent className="grid gap-6 p-5 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    {release.upcoming.length > 0 && (
                      <Section
                        icon={Lightbulb}
                        label="Upcoming"
                        items={release.upcoming}
