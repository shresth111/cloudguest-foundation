...
function LocationMapPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Location map"
        description="Geographical overview of all sites with real-time status."
      />
        ...
        <Card className="border-amber-500/20 bg-amber-500/5">
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-amber-600">{degradedCount}</p>
            </div>
          </CardContent>
        </Card>
        <Card className="border-rose-500/20 bg-rose-500/5">
          <CardContent className="flex items-center gap-3 p-4">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-rose-500/15 text-rose-600">
              <Activity className="h-4 w-4" />
            </div>
            <div>
              <p className="text-xs text-muted-foreground">Offline</p>
              <p className="text-lg font-bold text-rose-600">{offlineCount}</p>
            </div>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-lg font-bold">{totalRouters}</p>
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          {LOCATIONS.map((loc) => {
            ...
            return (
              ...
              >
                <div
                  className={cn(
                    "flex items-center justify-center rounded-full p-2 shadow-lg transition-all duration-200",
                    styles.dot,
                    ...
                    <Card className="border shadow-xl">
                      <CardContent className="p-3 text-left">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            variant="outline"
                            className={cn("h-4 px-1 text-[9px] capitalize", styles.badge)}
                          >
                            {loc.status}
                          </Badge>
                        </div>
                        ...
                        <div className="mt-2 flex flex-wrap gap-x-3 gap-y-1 text-[10px] text-muted-foreground">
                          <span>
                            {loc.onlineDevices}/{loc.totalDevices} devices
                          </span>
