  ...
  if (sign.phase === "phone") {
    return (
      ...
      >
         ...
         * Shared with the password tab (see GuestGroupPicker): leaving it
         * here alone meant a password guest was first asked about their
         * group after they were already online. */}
