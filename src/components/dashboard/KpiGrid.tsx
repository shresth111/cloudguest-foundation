...
const KPI_META: Record<string, { icon: ComponentType<{ className?: string }>; tone: StatTone }> = {
  totalCustomers: { icon: Users, tone: "primary" },
  ...
  registeredNas: { icon: Router, tone: "primary" },
  onlineNas: { icon: Signal, tone: "success" },
  offlineNas: { icon: Signal, tone: "danger" },
  totalRouters: { icon: Router, tone: "primary" },
  onlineRouters: { icon: Signal, tone: "success" },
  offlineRouters: { icon: Signal, tone: "danger" },
  activeSubscriptions: { icon: ShieldCheck, tone: "success" },
  ...
  licenseUsage: { icon: TicketCheck, tone: "info" },
  platformHealth: { icon: Activity, tone: "success" },
