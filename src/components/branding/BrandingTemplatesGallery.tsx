...
export function BrandingTemplatesGallery({
  brand,
  templates,
}: {
  brand: Brand;
    ...
    <Card>
      <CardHeader className="pb-3">
        ...
        <p className="text-xs text-muted-foreground">
          Kick-start a brand with a curated palette and typography preset.
        </p>
      </CardHeader>
      <CardContent>
                ...
                <div className="space-y-2 p-3">
                  ...
                  <div className="flex gap-2 pt-1">
                    <Button
                      ...
                      onClick={() =>
                        apply.mutate(
                          { brandId: brand.id, templateId: t.id },
                          { onSuccess: () => toast.success(`Applied ${t.name}`) },
                        )
                      }
                    >
                    ...
                    <Button
                      ...
                      variant="outline"
                      onClick={() =>
                        duplicate.mutate(brand.id, {
                          onSuccess: () => toast.success("Duplicated current brand"),
                        })
                      }
                    >
