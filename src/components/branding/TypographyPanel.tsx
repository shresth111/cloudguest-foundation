    ...
    <Card>
      ...
      <CardContent className="grid gap-4 md:grid-cols-2">
        ...
        <div>
          <Label>Shadow</Label>
          <Select
            value={brand.typography.shadow}
            onValueChange={(v) => set("shadow", v as Typography["shadow"])}
          >
            <SelectTrigger className="mt-1">
              <SelectValue />
            </SelectTrigger>
        ...
        <RangeRow
          label={`Base font size (${brand.typography.fontSize}px)`}
          value={brand.typography.fontSize}
          min={12}
          max={20}
          onChange={(v) => set("fontSize", v)}
        />
        <RangeRow
          label={`Heading weight (${brand.typography.headingWeight})`}
        ...
        />
        <RangeRow
          label={`Button weight (${brand.typography.buttonWeight})`}
          value={brand.typography.buttonWeight}
          min={400}
          max={900}
          step={100}
        ...
        />
        <RangeRow
          label={`Border radius (${brand.typography.borderRadius}px)`}
          value={brand.typography.borderRadius}
          min={0}
          max={32}
          onChange={(v) => set("borderRadius", v)}
        />
        <RangeRow
          label={`Card radius (${brand.typography.cardRadius}px)`}
          value={brand.typography.cardRadius}
          min={0}
          max={32}
        ...
        <div className="md:col-span-2">
          ...
          <Input
            className="mt-1"
            placeholder="e.g. Custom Sans, sans-serif"
            onBlur={(e) => e.target.value && set("fontFamily", e.target.value)}
          />
        </div>
      </CardContent>
    </Card>
