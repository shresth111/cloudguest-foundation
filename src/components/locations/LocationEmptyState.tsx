...
function DomainEmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-card/40 px-6 py-16 text-center">
      ...
      <div className="mt-6">
        <Button onClick={() => ctaTo && navigate({ to: ctaTo })}>{ctaLabel}</Button>
      </div>
    </div>
  );
}
...
export function LocationEmptyState() {
  return (
    <DomainEmptyState
      ...
      description="Add your first location to start managing guest WiFi."
...
export function VlanEmptyState() {
  return (
    <DomainEmptyState
      ...
      description="Create virtual networks to segment your guest traffic."
      ctaLabel="Create VLAN"
      ctaTo="/network/vlan"
    />
  );
}
...
export function DeviceEmptyState() {
  return (
    <DomainEmptyState
      ...
      description="Register your first router to start provisioning."
      ctaLabel="Register router"
      ctaTo="/routers"
    />
  );
}
...
export function UserEmptyState() {
  return (
    <DomainEmptyState
      ...
      description="Invite team members to collaborate on your network."
...
export function ReportEmptyState() {
  return (
    <DomainEmptyState
      ...
      description="Generate your first report to gain insights."
