 ...
 *
 * That expression is the contract, not this particular call: when the
 * sidebar was briefly restructured into nine "destinations" this page moved
 * to `destinationsFor()` in the same commit, and when that restructure was
 * reverted it moved back here. It has to travel with the sidebar in both
 * directions -- a help page grouped by seven headings a reader cannot find
 * in their sidebar, or by nine that no longer exist, is the same defect
 * either way. If you change what the sidebar renders, change this line with
 * it; the assertion in test-customer-nav-shell.mjs is there to make you.
 *
