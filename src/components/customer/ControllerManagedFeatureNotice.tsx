 ...
 * -------------------------------------------
 * Five screens (Network Zones, IP Addresses, Port Forwarding and Call
 * Priority in the Network group, and the Websites & IPs tab of Security ->
 * Blocking) are RouterOS writes. At a
