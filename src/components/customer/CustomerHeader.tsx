...
export function CustomerHeader({
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-white/10 bg-gradient-to-r from-[#3730a3] to-[#4338ca] px-4 text-white backdrop-blur-xl sm:px-6">
      ...
      <div className="relative">
        ...
        {menu && (
          <div className="absolute right-0 top-full z-50 mt-2 w-56 rounded-xl border border-white/10 bg-[#3730a3] p-1 text-white shadow-xl">
