      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 pb-24 overflow-y-auto">
          <div className="mx-auto max-w-7xl">
            ...
            {/* "background-image" no longer renders here -- the login
                screen's background image is a section of the Portal page
                itself now (see PortalBackgroundImage.tsx), and
                /background-image redirects to it, so this shell is never
                asked for that feature id. */}
