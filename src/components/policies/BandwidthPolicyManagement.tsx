...
import {
  useBandwidthPolicies,
  useBandwidthPolicyKpis,
  useSaveBandwidthPolicy,
  useDeleteBandwidthPolicy,
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: policy
      ? {
          ...
          downloadRateKbps: policy.downloadRateKbps,
          uploadRateKbps: policy.uploadRateKbps,
          burstDownloadKbps: policy.burstDownloadKbps,
          burstUploadKbps: policy.burstUploadKbps,
          burstThresholdKbps: policy.burstThresholdKbps,
          burstTimeSeconds: policy.burstTimeSeconds,
    ...
    >
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Raw rate-limit values, composed by the Queue Management engine.
          </DialogDescription>
        </DialogHeader>
        ...
        >
          ...
          <div className="rounded-lg border border-border/60 p-3">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <Field label="Download (Kbps)">
                <Input type="number" {...form.register("downloadRateKbps")} />
              </Field>
              <Field label="Upload (Kbps)">
                <Input type="number" {...form.register("uploadRateKbps")} />
              </Field>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-border/60 p-3">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <Field label="Burst download (Kbps)">
                <Input type="number" {...form.register("burstDownloadKbps")} />
              </Field>
              <Field label="Burst upload (Kbps)">
                <Input type="number" {...form.register("burstUploadKbps")} />
              </Field>
              <Field label="Burst threshold (Kbps)">
                <Input type="number" {...form.register("burstThresholdKbps")} />
              </Field>
              <Field label="Burst time (seconds)">
                <Input type="number" {...form.register("burstTimeSeconds")} />
              </Field>
            </div>
          </div>
