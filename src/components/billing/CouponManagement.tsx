      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Discount codes for onboarding and retention.
            </p>
          </div>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <EmptyState
              title="No coupons"
              description="Create your first coupon to give discounts."
...
function CouponEditor({
  ...
  const onSubmit = (values: CouponFormValues) => {
    save.mutate(
      { ...values, expiryDate: new Date(values.expiryDate).toISOString(), id: coupon?.id },
      {
        onSuccess: () => {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            ...
            <Select
              ...
              onValueChange={(v) => form.setValue("status", v as CouponStatus)}
            >
              <SelectTrigger className="mt-1">
                <SelectValue />
              </SelectTrigger>
