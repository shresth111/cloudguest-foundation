...
export function BillingQuickActions({
  ...
  const actions = [
    ...
    // user at the table below rather than acting on nothing.
    {
      ...
      onClick: () => toast.info("Select a subscription to upgrade"),
    },
    {
      label: "Downgrade plan",
      icon: ArrowDownCircle,
      tone: "text-amber-500 bg-amber-500/10",
      onClick: () => toast.info("Select a subscription to downgrade"),
    },
    {
      label: "Cancel subscription",
      icon: XCircle,
      tone: "text-rose-500 bg-rose-500/10",
      onClick: () => toast.info("Choose a subscription from the table"),
    },
    {
