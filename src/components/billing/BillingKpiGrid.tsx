  ...
  const tiles: { label: string; value: string; icon: typeof Users; tone: Tone; hint?: string }[] = [
    {
      ...
      value: money.format(data.mrr),
      icon: IndianRupee,
      tone: "success",
      hint: "MRR · projected value of active subscriptions",
    },
    {
      label: "Annual recurring revenue",
      value: money.format(data.arr),
      icon: TrendingUp,
      tone: "success",
      hint: "ARR · MRR × 12",
    },
    {
      ...
      value: fmt.format(data.activeSubscriptions),
      icon: Users,
      tone: "info",
    },
    {
      label: "Trial organizations",
      value: fmt.format(data.trialOrganizations),
      icon: Sparkles,
      tone: "warning",
    },
    {
      label: "Expiring plans",
      value: fmt.format(data.expiringPlans),
      icon: CalendarClock,
      tone: "warning",
      hint: "Next 14 days",
    },
    {
      ...
      value: fmt.format(data.overduePayments),
      icon: AlertOctagon,
      tone: "danger",
      hint: "Failed payments awaiting retry",
    },
    {
      label: "Total revenue",
    ...
    },
    {
      ...
      icon: Percent,
      tone: data.collectionRate >= 90 ? "success" : "warning",
      hint: "Share of recorded payments that succeeded",
    },
    {
      label: "ARPO",
      value: money.format(data.arpo),
      icon: Layers,
      tone: "info",
      hint: "Avg revenue / org",
    },
  ];
