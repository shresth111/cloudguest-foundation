            ...
            {LICENSES.map((l) => (
              <TableRow key={l.id}>
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className="bg-emerald-500/10 text-emerald-600 capitalize"
                  >
                    {l.status}
                  </Badge>
                </TableCell>
