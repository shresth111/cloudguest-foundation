...
export const SETTINGS_NAV: SettingsNavItem[] = [
  ...
  },
  {
    id: "branding",
    label: "Branding",
    description: "Logo, name & theme colors",
    icon: Palette,
    group: "Workspace",
  },
  {
    ...
    description: "Sign-in methods & sessions",
    icon: KeyRound,
    group: "Security",
  },
  {
    id: "security",
    label: "Security",
    description: "Access controls & audit",
    icon: ShieldCheck,
    group: "Security",
  },
  {
    id: "notifications",
    label: "Notifications",
    description: "Channels and endpoints",
    icon: Bell,
  ...
  },
  {
    id: "email",
    label: "Email",
    description: "Outbound email gateway",
    icon: FileText,
    group: "Communications",
  },
  {
    id: "sms",
    label: "SMS",
    description: "SMS provider & templates",
    icon: ScrollText,
    group: "Communications",
  },
  {
    id: "storage",
    label: "Storage",
    description: "Object storage & quotas",
    icon: HardDrive,
    group: "Platform",
  },
  {
  ...
  },
  {
    id: "api",
    label: "API",
    description: "Keys, webhooks & limits",
    icon: FileKey,
    group: "Platform",
  },
  {
  ...
  },
  {
    id: "feature_flags",
    label: "Feature flags",
    description: "Toggle major modules",
    icon: Flag,
    group: "Platform",
  },
  {
...
const GROUPS: SettingsNavItem["group"][] = [
  "Workspace",
  "Security",
  "Communications",
  "Platform",
                ...
                return (
                  <li key={item.id}>
                    ...
                    >
                      ...
                      <Icon
                        className={cn("mt-0.5 h-4 w-4 shrink-0", selected ? "text-primary" : "")}
                      />
