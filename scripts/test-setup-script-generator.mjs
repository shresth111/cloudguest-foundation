...
// =====================================================================
// 13. ONE WRITER PER HOTSPOT-PROFILE PROPERTY, AND NO ROUTER-SIGNED TLS
//     IN FRONT OF A GUEST
// =====================================================================
...
for (const [variant, script] of FULL_SCRIPTS) {
  ...
  check(
    ...
    (byProp.get("/ip hotspot profile login-by") ?? []).length === 1 &&
...
// =====================================================================
// 14. THE OS SIGN-IN POPUP: INTERCEPT THE PROBE, NEVER ALLOW IT
// =====================================================================
