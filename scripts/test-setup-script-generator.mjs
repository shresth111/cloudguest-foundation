 ...
 *
 * THE THREE FRESH-ROUTER TRAPS (sections 6-8, added 2026-08-23)
 * ------------------------------------------------------------
 ...
 *
 * 6. THE GENERATOR NEVER SET THE CLOCK.
 ...
 * 7. A BROKEN VENUE DNS PRODUCED A TUNNEL PEER POINTING AT NOTHING.
 ...
 * 8. RE-CLICKING GENERATE SILENTLY INVALIDATED THE SCRIPT ON SCREEN.
 ...
 *    Section 8 asserts that table against what the generator ACTUALLY
...
const VARIANTS = [
  ...
  // The two WireGuard-endpoint shapes section 7 exists for, in the sweep
...
// =====================================================================
// 6. THE CLOCK IS SET, EARLY, AND ITS FAILURE IS VISIBLE
// =====================================================================
// `grep -c "ntp client\|time-zone-name"` over the generator returned 0.
...
// =====================================================================
// 7. A TUNNEL PEER IS NEVER BUILT AGAINST AN UNRESOLVED NAME
// =====================================================================
...
// =====================================================================
// 8. THE PANEL'S "WHAT A RE-GENERATE BREAKS" TABLE IS TRUE
// =====================================================================
...
const FULL = buildRouterSetupScriptChunks({
  ...BASE,
  wans: [DHCP_WAN],
  wireguard: WG,
  radius: { serverAddress: "10.20.0.1", sharedSecret: "s3cr3t" },
...

{
  ...
  check(
    ...
    /wg-cloudguest/.test(SECRET_REPAIR.wireguard.why),
